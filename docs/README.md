...
- [Android direct-proof fleet reports](reference/android-direct-proof-fleet-reports.md) — the repository-local report bundle layout, artifact references, and troubleshooting entry points for direct-proof runs.
