...
class SessionBoundarySelectionPolicyTest {
    ...
    fun `supported live selection to solo requires a supported boundary`() {
        ...
        // Assert
        val boundaryDecision = assertIs<SessionSurfaceChoice.RequireBoundaryConfirmation>(decision)
        assertEquals(
    ...
    fun `alternative sessions keep the current surface without a new boundary`() {
        ...
        // Assert
        val selectionDecision = assertIs<SessionSurfaceChoice.SelectSurface>(decision)
    ...
    fun `supported ended selection to solo starts a new session immediately`() {
        ...
        // Assert
        val startDecision = assertIs<SessionSurfaceChoice.StartAlternativeSession>(decision)
