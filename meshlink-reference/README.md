...
| inspect retained benchmark evidence and proof baselines | [Benchmarks and retained evidence](../meshlink-benchmark/README.md) |
...
- for Android direct proof on aggressive OEM builds, keep the screen awake or disable battery optimization for the reference app
