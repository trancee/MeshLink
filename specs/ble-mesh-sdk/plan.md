...
**Language/Version**: Kotlin 2.3.21, Kotlin Multiplatform, JVM toolchain 17  
**Primary Dependencies**: Runtime: Kotlin stdlib 2.3.21 + `kotlinx-coroutines-core` 1.11.0 only; Build/Test: exact pinned versions of `kotlin-test`, Binary Compatibility Validator, Kover, Power-assert, and kotlinx-benchmark declared in `gradle/libs.versions.toml`  
...
- [x] Quality gates are translated: feature-branch workflow, formatting,
      ...
      conditional YAML linting are represented in the plan/tasks or recorded as
      non-applicable for this feature.
...
again: fresh headless OPPO reruns first retained `66.12-71.67 KB/s` with
