# Android direct-proof fleet run 20260620T164700

This bundle captures the latest rerun of the attached Android fleet after the direct-proof launch and final-pass seeding updates.
...
- The runner now launches sender and passive in parallel.
- The final pass is seeded from discovery evidence even when the initial run fails.
- The first six completed pairs still ended in capture-stage route failures, so the new behavior improved classification but did not yet convert these devices into passes.
