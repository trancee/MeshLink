...
- Pair report path: `/home/phil/Projects/MeshLink/reports/android-direct-proof-fleet/runs/20260618T161949/24_cph2359_mi_note3_report.md`
- Peer lookup time: —
- Initial run dir: `—`
- Final run dir: `—`
...
- Guardrail: SDK 28 devices are explicitly classified as unsupported before capture (senderApiLevel=34 passiveApiLevel=28).
