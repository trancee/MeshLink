...
- Pair report path: `/home/phil/Projects/MeshLink/reports/android-direct-proof-fleet/runs/20260618T161949/08_nam_lx9_mi_note3_report.md`
- Peer lookup time: —
- Initial run dir: `—`
- Final run dir: `—`
...
- Guardrail: SDK 28 devices are explicitly classified as unsupported before capture (senderApiLevel=31 passiveApiLevel=28).
- Initial run failure: SDK 28 direct-proof guardrail: passive API 28 device(s) are explicitly classified as unsupported before capture
- Final run failure: SDK 28 direct-proof guardrail: passive API 28 device(s) are explicitly classified as unsupported before capture
