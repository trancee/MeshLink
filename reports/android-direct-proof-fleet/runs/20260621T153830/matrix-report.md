...
sequenceDiagram
    ...
    rect rgba(30, 64, 175, 0.40)
        ...
        note over Fleet,Sweep: failure bucket so far = launch timeout
    end
    rect rgba(236, 253, 245, 0.55)
        ...
        note over Sweep: top failure bucket = launch timeout
...
- Fleet JSON: `/home/phil/Projects/MeshLink/reports/android-direct-proof-fleet/runs/20260621T153830/fleet.json`
- Fail-fast: disabled
- Stopped early: yes
- Stop reason: failure count 6 exceeded max-failures=5; investigate the recorded failures before continuing
