# Android direct-proof fleet run 20260621T153830

This bundle captures the rerun of the attached Android fleet after the direct-proof launch-floor and route-failure detection fixes.
...
- The matrix stopped after the sixth failure because `--max-failures=5` was exceeded with continue-on-failure enabled.
- The pair reports and matrix report are the source of truth for the failure-stage evidence.
