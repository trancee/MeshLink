 ...
 *
 * Delivery outcomes that callers can recover from locally remain modeled as
 * [SendResult]. Exceptions are reserved for invalid configuration, invalid API
 * usage, or subsystem failures that prevented MeshLink from executing the
 * requested operation.
 */
