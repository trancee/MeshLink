 ...
 *
 * Plain class (not data class) so that the hand-written [equals] can be fully covered by tests: a
 * data class would generate a synthetic equals whose `!is MessageIdKey` branch is unreachable via
