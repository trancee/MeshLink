---
name: core-bluetooth
description: Complete reference for Apple's Core Bluetooth framework from the official developer documentation and the Core Bluetooth Programming Guide (Apple Documentation Archive). Covers both central and peripheral roles for Bluetooth Low Energy (BLE) and BR/EDR Classic communication on iOS, macOS, tvOS, visionOS, and watchOS. Central role — CBCentralManager (scan for peripherals with scanForPeripherals(withServices:options:), connect/cancelPeripheralConnection, retrieveConnectedPeripherals/retrievePeripherals, state restoration with CBCentralManagerOptionRestoreIdentifierKey, registerForConnectionEvents, isScanning, delegate CBCentralManagerDelegate with centralManagerDidUpdateState/didDiscover/didConnect/didDisconnectPeripheral/didFailToConnect/willRestoreState/connectionEventDidOccur). CBPeripheral (discoverServices, discoverCharacteristics(_:for:), discoverDescriptors(for:), readValue(for:) characteristic and descriptor, writeValue(_:for:type:) with CBCharacteristicWriteType .withResponse/.withoutResponse, setNotifyValue(_:for:) for notifications, maximumWriteValueLength(for:), canSendWriteWithoutResponse, openL2CAPChannel, readRSSI, delegate CBPeripheralDelegate with didDiscoverServices/didDiscoverCharacteristicsFor/didUpdateValueFor/didWriteValueFor/didUpdateNotificationStateFor/didReadRSSI/didOpenL2CAPChannel, CBPeripheralState disconnected/connecting/connected/disconnecting). Peripheral role — CBPeripheralManager (add/remove/removeAllServices with CBMutableService, startAdvertising with CBAdvertisementDataLocalNameKey/CBAdvertisementDataServiceUUIDsKey, stopAdvertising, isAdvertising, respond(to:withResult:) for CBATTRequest, updateValue(_:for:onSubscribedCentrals:) returns Bool for queue ready, publishL2CAPChannel(withEncryption:)/unpublishL2CAPChannel, setDesiredConnectionLatency, delegate CBPeripheralManagerDelegate with , not available for advertising on watchOS/tvOS/visionOS). Service hierarchy — CBService/CBMutableService (uuid, isPrimary, includedServices, characteristics), CBCharacteristic/CBMutableCharacteristic (uuid, value, properties CBCharacteristicProperties .read/.write/.writeWithoutResponse/.notify/.indicate/.authenticatedSignedWrites/.extendedProperties/.notifyEncryptionRequired/.indicateEncryptionRequired, permissions CBAttributePermissions .readable/.writeable/.readEncryptionRequired/.writeEncryptionRequired, descriptors, isNotifying, subscribedCentrals), CBDescriptor/CBMutableDescriptor, CBUUID (from string/data/16-bit/32-bit), CBL2CAPChannel (peer, inputStream/outputStream, PSM), CBATTRequest (central, characteristic, offset, value). Info.plist (NSBluetoothAlwaysUsageDescription required iOS 13+, NSBluetoothPeripheralUsageDescription for iOS 12-, bluetooth-central/bluetooth-peripheral background modes). State management (must wait for .poweredOn from centralManagerDidUpdateState/peripheralManagerDidUpdateState before calling any methods, CBManagerState unknown/resetting/unsupported/unauthorized/poweredOff/poweredOn). Programming guide topics — GATT data hierarchy, step-by-step central and peripheral role Objective-C walkthroughs, static vs dynamic characteristic values (value:nil for dynamic/delegate-driven, non-nil for static/cached), iOS background processing (foreground-only behavior, background execution modes, behavioral differences foreground vs background, state preservation and restoration 4-step process), best practices for central (stop scanning early, avoid AllowDuplicatesKey, discover only needed services/characteristics, subscribe vs poll, three reconnection strategies), best practices for peripheral (advertising data limits 28+10 bytes with overflow area, user-controlled advertising, always support notifications, encryption-required permissions for automatic pairing). Do not subclass any Core Bluetooth class. Use when implementing BLE scanning, connecting to peripherals, discovering services and characteristics, reading/writing values, notifications/indications, hosting a GATT server on iOS/macOS, advertising services, using L2CAP channels, state restoration, background BLE, or any Core Bluetooth question.
---
